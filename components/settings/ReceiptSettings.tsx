        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
                ...
                <div className="mt-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label htmlFor="layawayPrefix" className="block text-xs font-medium text-slate-600">Layaway Prefix</label>
                        <input type="text" name="layawayPrefix" id="layawayPrefix" value={formData.layawayPrefix} onChange={handleChange} className="mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md shadow-sm focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm" />
                    </div>
                     <div>
                        <label htmlFor="workOrderPrefix" className="block text-xs font-medium text-slate-600">Work Order Prefix</label>
                        <input type="text" name="workOrderPrefix" id="workOrderPrefix" value={formData.workOrderPrefix} onChange={handleChange} className="mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md shadow-sm focus:outline-none focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm" />
                    </div>
                </div>
            </div>
