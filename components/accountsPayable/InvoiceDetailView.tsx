...
interface InvoiceDetailViewProps {
    ...
    settings: Settings;
    onBack: () => void;
    onEmailRequest: (invoiceId: string, supplierId: string) => void;
}

const InvoiceDetailView: React.FC<InvoiceDetailViewProps> = ({ invoice, supplier, purchaseOrder, settings, onBack, onEmailRequest }) => {
                ...
                <div className="flex flex-col md:flex-row gap-4 justify-between items-center">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-2">
                        ...
                        >
                         ...
                         <motion.button 
                            onClick={() => onEmailRequest(invoice.id, invoice.supplierId)}
                            whileTap={{ scale: 0.95 }}
