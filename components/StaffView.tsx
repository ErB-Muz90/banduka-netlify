                 ...
                 {canManage && (
                     <div className="flex items-center space-x-2">
                        <motion.button 
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="bg-white dark:bg-slate-700 text-slate-700 dark:text-slate-200 border border-slate-300 dark:border-slate-600 font-bold px-4 py-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-600"
                        >
