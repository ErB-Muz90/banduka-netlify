...
export const EndShiftModal: React.FC<EndShiftModalProps> = ({ activeShift, sales, onConfirmEndShift, onCancel }) => {
            ...
            >
                ...
                <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                    ...
                    <div className="pt-4 flex justify-end space-x-3">
                         <motion.button type="button" onClick={onCancel} {...{ whileTap: { scale: 0.95 } }} className="px-4 py-2 text-sm font-bold bg-background text-foreground dark:bg-dark-border dark:text-dark-foreground rounded-md hover:bg-border dark:hover:bg-dark-border/50">
                            Cancel
                        </motion.button>
                        <motion.button type="submit" {...{ whileTap: { scale: 0.98 } }} className="px-6 py-2 text-sm font-bold text-white rounded-md bg-primary hover:bg-primary-focus">
                            Confirm & End Shift
                        </motion.button>
                    </div>
                </form>
