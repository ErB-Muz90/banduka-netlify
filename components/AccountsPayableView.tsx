                ...
                <table className="w-full text-sm text-left text-slate-500 dark:text-slate-400">
                    ...
                    <tbody>
                        {invoices.map(invoice => {
                            ...
                            return (
                                <tr key={invoice.id} onClick={() => onViewInvoice(invoice)} className="bg-white dark:bg-slate-800 border-b dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700 cursor-pointer">
