import { CartItem, Sale, Product, Customer, Supplier, PurchaseOrder, SupplierInvoice, Quotation, User, Settings, AuditLog, Shift, TimeClockEvent, Payout, Layaway, WorkOrder, SalesOrder, HeldReceipt } from '../types';
...
const STORES = [
    ...
    'layaways', 'workOrders', 'salesOrders', 'heldReceipts'
];
